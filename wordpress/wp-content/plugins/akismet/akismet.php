...
Description: Akismet はコメントがスパムかどうか Akismet ウェブサービスに確認します。このプラグインを使用するには<a href="http://wordpress.com/api-keys/">WordPress.com API キー</a>が必要です。"コメント"メニュー以下で捕らえたコメントを閲覧することができます。Akismet が捕らえたスパムコメントの数を表示するにはテンプレートに <code>&lt;?php akismet_counter(); ?></code> を挿入します。
Version: 2.0.2
